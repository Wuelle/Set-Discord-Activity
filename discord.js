const injectionCode = () => {
    ...
    // Inject some js Code into the tab and execute it
    injectScript = text => {
...
port.onMessage.addListener(msg => {
    ...
    console.log(msg.type !== undefined, msg.name !== undefined)
    if (msg.action) {
        switch (msg.action) {
            case "close":
                closeOK = true
        ...
        // DEBUG
        console.log("Trying to set status to");
        console.log(msg);
...
console.log("THIS MUST BE TRUE", port.onMessage.hasListener());
